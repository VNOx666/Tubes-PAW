<?php $__env->startSection('content'); ?>
    <div class="flex items-start justify-between gap-3">
        ...
        <a href="<?php echo e(route('seller.products.create')); ?>" class="px-4 py-2 rounded-2xl bg-black text-white hover:opacity-90">+
            Tambah Barang</a>
    </div>
            ...
            <?php $__currentLoopData = range(1, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-4 flex items-center gap-4">
                    <div
                        ...
                        foto</div>
                    <div class="flex-1">
                        <div class="font-bold">Produk #<?php echo e($i); ?></div>
                        <div class="text-sm text-zinc-600">Rp <?php echo e(number_format(100000 + $i * 10000, 0, ',', '.')); ?> • Grade A
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', ['title' => 'Produk Saya — Thrifty'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Tubes-PAW-1\resources\views/pages/seller/products/index.blade.php ENDPATH**/ ?>